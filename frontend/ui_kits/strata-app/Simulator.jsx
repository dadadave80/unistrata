/* global React */
(function () {
const { Panel, Stat, Badge, StrataCore, MoneyChart, NumberTicker } = window.StrataDesignSystem_8a0ec2;
    ...
    <div>
      <div className="sm__head">
        <div>
          ...
          <p className="sm__sub">Pick a scenario and scrub the price path. The capital structure and the money chart respond in sync — watch Sediment compress while Bedrock holds its line.</p>
        </div>
      ...
      <div className="sm__grid">
        ...
        <Panel padded>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 11, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--text-tertiary)', marginBottom: 'var(--space-5)' }}>Depositor outcome · index = 100 at t0</div>
